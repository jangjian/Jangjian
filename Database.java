...
public class Database {
	Connection con = null;
	Statement stmt = null;
	String url = "jdbc:mysql://localhost:3306/jspbookdb";	//dbstudy 스키마
	String user = "root";
	String passwd = "1011";		//본인이 설정한 root 계정의 비밀번호를 입력하면 된다.
	...
	public void logincheck1(String uid, String upass) {
	}
}
